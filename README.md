...
A privacy-first RAG platform that leverages Spring AI and local LLMs (Llama 3.2 via Ollama) to enable secure interaction with your data without relying on external APIs.
