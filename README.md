...
<h2 align="center">Senior Software Engineer | AI Architect | Technical Author</h2>
...
### About Me
- Currently working as a **Senior Software Engineer** Freelancer.
...
A privacy-first **RAG** platform that leverages **Spring AI** and local LLMs (**Llama 3** via **Ollama**) to enable secure interaction with your data without relying on external APIs.
...
#### 3. **GYM** [🔗 GitHub Repo](https://github.com/AndrzejSzelag/gym)
...
#### 4. **Keycloak JWT Validator** [🔗 GitHub Repo](https://github.com/AndrzejSzelag/keycloak-jwt-validator-springboot-react)
...
#### 5. **Fault Management System** [🔗 GitHub Repo](https://github.com/AndrzejSzelag/fms)
